...
(function(factory) {
	...
	Datepicker.prototype = {
		...
		fill: function() {
			...
			if(this.o.beforeShowMonth !== $.noop) {
				...
				$.each(months, function(i, month) {
					...
					if(before.enabled === !1 && !$(month).hasClass('disabled')) $(month).addClass('disabled');
		...
		_toggle_multidate: function(date) {
			...
			if(ix !== -1) {
				if(this.o.multidate === !0 || this.o.multidate > 1 || this.o.toggleActive) {
	...
	var defaults = $.fn.datepicker.defaults = {
		...
		clearBtn: !1,
		toggleActive: !1,
		daysOfWeekDisabled: [0,1,2,3,6,7],
