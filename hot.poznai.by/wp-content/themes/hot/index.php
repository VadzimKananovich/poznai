<?php get_header(); ?> 
<div class="row align-center" style="background:url(<?php echo get_template_directory_uri(); ?>/dist/images/egupt.jpg) center center">
	<div class="col col-9">
	...
	<div class="row align-center">
		<div class="col"><h1 class="text-center" style="margin:80px 0;color:#fff;"><b>ГОРЯЩИЕ ТУРЫ В ЕГИПЕТ от <span class="red">274$</span></b></h1></div>
	</div>
...
<div id="navbar">
	...
	<nav id="navbar-main">
		<ul>
			<li><a href="http://hot.poznai.by/" class="active">Египет</a></li>
