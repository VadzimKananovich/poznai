...
<head>
	...
	<link rel="stylesheet" href="<?php echo $src_url; ?>css/main.css">
	<link rel="stylesheet" href="<?php echo $src_url; ?>css/preloader.css">
	...
	<link href="<?php echo $src_url; ?>css/icons.css" rel="stylesheet">
...
<body>
	...
	<script src="<?php echo $src_url; ?>js/main.js"></script>
	...
	// var src_url = 'http://192.168.1.3:888/trsucavets_new/';
