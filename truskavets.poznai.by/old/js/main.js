...
function openModalRelax() {
	...
	let indicators = modalWindow.querySelector('#modalWindowSlider .carousel-indicators');
	...
	let modalTitle = modalWindow.querySelector('#modalWindowSlider .modal-title');
	modalTitle.innerHTML = '';
	modalTitle.appendChild(relaxTitle);

	let modalSecondTitle = modalWindow.querySelector('#modalWindowSlider .modal-second-title');
	modalSecondTitle.innerHTML = '';
	modalSecondTitle.appendChild(relaxModalTitle);

	let modalContent = modalWindow.querySelector('#modalWindowSlider .modal-content-wrap p');
	modalContent.innerHTML = '';
	modalContent.innerHTML = relaxContent;

	// CREATE CAROUSEL
	let modalCarousel = modalWindow.querySelector('#modalWindowSlider .carousel-inner');
