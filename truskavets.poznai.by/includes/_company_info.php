...
//																CREATE ABOUT
//===================================================================================
$about_file = json_decode(file_get_contents('JSON/about.json'));
...
if($_social && count($_social) > 0){
	...
	<meta itemprop="description" content="'.$_company_desc.'"/>
	<meta itemprop="image" content="'.$url.$_logo.'"/>

	<meta property="og:locale" content="ru_RU"/>
	<meta property="og:type" content="website"/>
	<meta property="og:title" content="Туры в Трускавец из Минска - отдых для всей семьи в Украине"/>
	<meta property="og:description" content="
	Горнолыжный курорт Трускавец. Горный воздух, горная вода, оздоровительная программа. Все включено!
	"/>
	...
	<meta name="twitter:card" content="Туры в Трускавец из Минска - отдых для всей семьи в Украине">
	<meta name="twitter:site" content="'.$_company_name.'">
	<meta name="twitter:title" content="Туры в Трускавец из Минска - отдых для всей семьи в Украине">
