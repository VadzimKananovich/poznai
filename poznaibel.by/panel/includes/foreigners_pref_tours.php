<div class="container-fluid">
	<div class="mrt-3 mrb-2">
		<div class="row">
			<div class="col-md-12">
				<h2 class="text-center mrb-1">Сборные туры</h2>
			</div>
		</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form  method="post" action="includes/request_tours.php?action=edit_info&type=foreigners_pref_add_img" enctype="multipart/form-data">
					<div class="row mrb-1">
						<div class="col-md-5">
...
<div class="modal fade" id="editBelarusTour" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document" style="margin:0; margin-left:13px">
		<div class="modal-content" style="width:96vw;">
			...
			<form  method="post" action="includes/request_tours.php?action=edit_info&type=foreigners_pref_edit_tour">
				<div class="modal-body">
					<div class="form-group">
...
<div class="modal fade" id="addBelarusTour" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document" style="margin:0; margin-left:13px">
		<div class="modal-content" style="width:96vw;">
			...
			<form  method="post" action="includes/request_tours.php?action=edit_info&type=foreigners_pref_add_tour">
				<div class="modal-body">
					<div class="form-group">
						<label for="inputDate">Дата</label>
						<input type="text" class="form-control" id="inputDate" name="inputDate">
					...
					<div class="form-group">
						<label for="inputDurationAdd">Продолжительность</label>
						<input type ='text' class="form-control" id="inputDurationAdd" name="inputDurationAdd">
					</div>
					<div class="form-group">
...
<div class="modal fade" id="delBelarusTour" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form  method="post" action="includes/request_tours.php?action=edit_info&type=foreigners_pref_del_tour">
				<div class="modal-body">
					<div class="col-md-12">
...
<div class="modal fade" id="renameSectionModal" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form  method="post" action="includes/request_tours.php?action=edit_info&type=foreigners_pref_rm_section">
				<div class="modal-body">
					<div class="form-group">
